...
all : results/confusion_matrix_test.csv results/cv_score.csv results/lr_confusion_matrix.csv data/processed/pipe_lr.pkl data/processed/preprocessor.pkl results/pandas_preliminary_eda_mushrooms.html
...
# preliminary eda
results/pandas_preliminary_eda_mushrooms.html : data/processed/train_df.csv src/preliminary_pandas_eda.py
...
# create preprocessor
data/processed/preprocessor.pkl : data/processed/X_train.csv data/processed/y_train.csv
...
results/cv_score.csv results/lr_confusion_matrix.csv data/processed/pipe_lr.pkl : data/processed/X_train.csv data/processed/y_train.csv
...
results/confusion_matrix_test.csv : src/test_lr_model_results.py data/processed/X_test.csv data/processed/y_test.csv
